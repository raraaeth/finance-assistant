/* =====================================================
   ...
   New :
   - Module dapat menyediakan getRuleState()
     untuk membaca status rule yang sudah ada
   - Fixed rule yang sudah ada dapat dinonaktifkan
     sebelum user membuat result baru
   - UI rule state bersifat opt-in
   - Module lain tidak terpengaruh jika tidak
     menggunakan hook tersebut
===================================================== */
...
export const Setting = {
    ...
    async open(
        ...
        /* =============================================
           ...
           Async karena module dapat memiliki
           persistent rule state yang perlu
...
async function renderContent(
    ...
    /* =============================================
       ...
       Tetap berurutan agar state rule module
       selesai diterapkan sebelum UI dibuka.
    ============================================= */
...
async function renderSection(
    ...
    /* =============================================
       ...
       Hanya aktif jika module secara eksplisit
       menyediakan getRuleState().
       
       Module lain yang tidak menggunakan hook
       tidak berubah.
    ============================================= */
...
/* =====================================================
   APPLY PERSISTENT RULE STATE
===================================================== */

/*
 * Module dapat menggunakan hook:
 *
 * section.getRuleState()
 *
 ...
 * }
 *
 * Controller hanya menangani state UI.
 *
 * Penentuan rule apa yang sudah ada tetap
 * menjadi tanggung jawab module.
 */

async function applyPersistentRuleState(
    ...
    /* =============================================
       ...
       Supaya dapat digunakan kembali ketika
       form dibuka.
    ============================================= */
...
function normalizeRuleState(
    ...
    /* =============================================
       ...
       Array dianggap berisi nama rule yang
       sudah dibuat.
    ============================================= */
 ...
 * UI behavior:
 *
 * Jika rule sudah dibuat:
 *
 *     ✓ Rule X sudah dibuat
 *
 * Checkbox tidak lagi dapat dipilih.
 *
 * Jika semua fixed rule sudah dibuat:
 *
 *     tombol Tambah disembunyikan.
 *
 * Penting:
 * Tidak semua checkbox otomatis dianggap rule.
 *
 * Module harus menyediakan:
 *
 * section.ruleStateFields
 *
 * Contoh nanti:
 *
 * ruleStateFields: {
 ...
 * }
 *
 * Dengan begitu controller tetap generic.
 */

function applyRuleStateUI(
        ...
        ([ruleKey, config]) => {
            ...
            const wrapper =
                ...
                sectionElement.querySelector(
                    ...
                    `.global-setting-field[data-field="${escapeSelector(
            ...
            /* =====================================
               ...
               Untuk fixed rule, checkbox diganti
               dengan status.
            ===================================== */

            if(

                config.replaceWithStatus !== false
...
function renderForm(
    ...
    /* =============================================
       ...
       State yang sudah dibaca ketika section
       dirender diterapkan lagi setelah form
       dibuat.
    ============================================= */

    applyStoredRuleStateToForm(
...
/* =====================================================
   APPLY STORED RULE STATE TO FORM
===================================================== */

function applyStoredRuleStateToForm(
